...
async function enter(){
  if(!SCHEMA) SCHEMA=await (await fetch('data/input_schema.json?v=auto-20260529-1712')).json();
  try{ RANGES=await (await fetch('data/input_ranges.json?v=auto-20260529-1712')).json(); }catch(e){ RANGES={}; }
  show('app');
