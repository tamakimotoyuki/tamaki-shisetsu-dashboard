...
async function enter(){
  if(!SCHEMA) SCHEMA=await (await fetch('data/input_schema.json?v=20260528m')).json();
  try{ RANGES=await (await fetch('data/input_ranges.json?v=20260528m')).json(); }catch(e){ RANGES={}; }
  show('app');
